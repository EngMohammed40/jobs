...
<form action="{{route('admin.corporations_rules.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label>الشروط</label>
            <textarea class="form-control rounded" name="rule" id="banner_body"></textarea>
        </div>
    </div>
</div>
