            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive mt-1">
                        <a href="{{route('admin.other-websites-free.create')}}" class="btn btn-primary mr-2 ml-2  mb-1 waves-effect waves-light">اضافة جديد</a>
                        <table id="datatable" class="table table-hover-animation mb-0">
                            ...
                            @foreach($websites as $website)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{route('admin.other-websites-free.show', $website->id)}}" class="btn btn-success">عرض</a>
                                            <a href="{{route('admin.other-websites-free.edit', $website->id)}}" class="btn btn-primary">تعديل</a>
                                ...
                                <div class="modal fade text-left" id="delete_user_{{$website->id}}" tabindex="-1" role="dialog" aria-labelledby="delete_user_{{$website->id}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <form action="{{route('admin.other-websites-free.destroy', $website->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
