                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-shopping-cart"></i><span class="badge badge-pill badge-primary badge-up cart-item-count">6</span></a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-cart dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list"><a class="cart-item" href="app-ecommerce-details.html">
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="{{asset('assets/admin/app-assets/images/pages/eCommerce/4.png')}}" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="{{asset('assets/admin/app-assets/images/pages/eCommerce/dell-inspirion.jpg')}}" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="{{asset('assets/admin/app-assets/images/pages/eCommerce/7.png')}}" width="88" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="{{asset('assets/admin/app-assets/images/pages/eCommerce/10.png')}}" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="{{asset('assets/admin/app-assets/images/pages/eCommerce/sony-75class-tv.jpg')}}" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="{{asset('assets/admin/app-assets/images/pages/eCommerce/canon-camera.jpg')}}" width="70" alt="Cart Item"></div>
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">John Doe</span><span class="user-status">Available</span></div><span><img class="round" src="{{asset('assets/admin/app-assets/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar" height="40" width="40"></span>
                            </a>
